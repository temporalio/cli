...
func (v *DeploymentVersionOptions) buildFlags(cctx *CommandContext, f *pflag.FlagSet) {
	f.StringVarP(&v.Version, "version", "v", "", "Fully-qualified name for a Worker Deployment Version. Use the format `YourDeploymentName.YourBuildID`. Required.")
	_ = cobra.MarkFlagRequired(f, "version")
}
...
func NewTemporalWorkerDeploymentCommand(cctx *CommandContext, parent *TemporalWorkerCommand) *TemporalWorkerDeploymentCommand {
	...
	s.Command.AddCommand(&NewTemporalWorkerDeploymentVersionCommand(cctx, &s).Command)
	return &s
}
...
func NewTemporalWorkerDeploymentDeleteCommand(cctx *CommandContext, parent *TemporalWorkerDeploymentCommand) *TemporalWorkerDeploymentDeleteCommand {
	...
	s.Command.DisableFlagsInUseLine = true
	s.Command.Use = "delete [flags]"
	s.Command.Short = "Deletes a Worker Deployment"
	if hasHighlighting {
...
type TemporalWorkerDeploymentVersionCommand struct {
	Parent  *TemporalWorkerDeploymentCommand
	Command cobra.Command
}

func NewTemporalWorkerDeploymentVersionCommand(cctx *CommandContext, parent *TemporalWorkerDeploymentCommand) *TemporalWorkerDeploymentVersionCommand {
	var s TemporalWorkerDeploymentVersionCommand
	s.Parent = parent
	s.Command.Use = "version"
	s.Command.Short = "Describe, delete, setCurrent, or setRamping, a Deployment Version"
	if hasHighlighting {
	...
	s.Command.Args = cobra.NoArgs
	s.Command.AddCommand(&NewTemporalWorkerDeploymentVersionDeleteCommand(cctx, &s).Command)
	s.Command.AddCommand(&NewTemporalWorkerDeploymentVersionDescribeCommand(cctx, &s).Command)
	s.Command.AddCommand(&NewTemporalWorkerDeploymentVersionSetCurrentCommand(cctx, &s).Command)
	s.Command.AddCommand(&NewTemporalWorkerDeploymentVersionSetRampingCommand(cctx, &s).Command)
	return &s
}

type TemporalWorkerDeploymentVersionDeleteCommand struct {
	Parent  *TemporalWorkerDeploymentVersionCommand
	Command cobra.Command
...
func NewTemporalWorkerDeploymentVersionDeleteCommand(cctx *CommandContext, parent *TemporalWorkerDeploymentVersionCommand) *TemporalWorkerDeploymentVersionDeleteCommand {
	var s TemporalWorkerDeploymentVersionDeleteCommand
	s.Parent = parent
	s.Command.DisableFlagsInUseLine = true
	s.Command.Use = "delete [flags]"
	s.Command.Short = "Deletes a Worker Deployment Version"
	if hasHighlighting {
...
type TemporalWorkerDeploymentVersionDescribeCommand struct {
	Parent  *TemporalWorkerDeploymentVersionCommand
	Command cobra.Command
	DeploymentVersionOptions
}

func NewTemporalWorkerDeploymentVersionDescribeCommand(cctx *CommandContext, parent *TemporalWorkerDeploymentVersionCommand) *TemporalWorkerDeploymentVersionDescribeCommand {
	var s TemporalWorkerDeploymentVersionDescribeCommand
	s.Parent = parent
	s.Command.DisableFlagsInUseLine = true
	s.Command.Use = "describe [flags]"
...
type TemporalWorkerDeploymentVersionSetCurrentCommand struct {
	Parent  *TemporalWorkerDeploymentVersionCommand
	Command cobra.Command
	DeploymentVersionOptions
...
func NewTemporalWorkerDeploymentVersionSetCurrentCommand(cctx *CommandContext, parent *TemporalWorkerDeploymentVersionCommand) *TemporalWorkerDeploymentVersionSetCurrentCommand {
	var s TemporalWorkerDeploymentVersionSetCurrentCommand
	s.Parent = parent
	s.Command.DisableFlagsInUseLine = true
	...
	s.Command.Args = cobra.NoArgs
	s.Command.Flags().StringVar(&s.DeploymentName, "deployment-name", "", "Deployment name. Only needed when `--version` is `__unversioned__` or empty.")
	s.Command.Flags().StringVar(&s.Identity, "identity", "", "Identity of the user submitting this request.")
...
type TemporalWorkerDeploymentVersionSetRampingCommand struct {
	Parent  *TemporalWorkerDeploymentVersionCommand
	Command cobra.Command
	DeploymentVersionOptions
	DeploymentName          string
...
func NewTemporalWorkerDeploymentVersionSetRampingCommand(cctx *CommandContext, parent *TemporalWorkerDeploymentVersionCommand) *TemporalWorkerDeploymentVersionSetRampingCommand {
	var s TemporalWorkerDeploymentVersionSetRampingCommand
	s.Parent = parent
	s.Command.DisableFlagsInUseLine = true
	s.Command.Use = "set-ramping [flags]"
	...
	s.Command.Args = cobra.NoArgs
	s.Command.Flags().StringVar(&s.DeploymentName, "deployment-name", "", "Deployment name. Only needed when `--version` is `__unversioned__` or empty.")
	s.Command.Flags().Float32Var(&s.Percentage, "percentage", 0, "Percentage of tasks redirected to the Ramping Version. Valid range [0,100]. Required.")
	_ = cobra.MarkFlagRequired(s.Command.Flags(), "percentage")
