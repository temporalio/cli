...
var (
	...
	FlagTimeZone                    = "time-zone"FlagTLS                        = "tls"
	...
	FlagUICodecEndpoint             = "ui-codec-endpoint"FlagUIIP                       = "ui-ip"
	FlagUIPort                      = "ui-port"
	FlagUnpause                     = "unpause"FlagUpdateFirstExecutionRunID  = "first-execution-run-id"
	...
	FlagIncludeRetirementCandidates = "include-retirement-candidates"
	FlagIncludePollerCompatibility  = "include-poller-compatibility"
)
